...
const EmailCheckPage = () => {
  ...
  const { getUserByEmail, getUserMilestoneLevel, isLoading, setIsLoading } = useUserData();
  ...
  return (
    <div>
      ...
      >
        <h1 className="heading-2 mb-6">Check Your Progress by Email</h1>
        ...
        <div className="card mb-8">
          ...
          <div className="mt-4 text-sm text-gray-600">
            <p>For testing: Use "test" as the email to see a demo profile</p>
          </div>
        </div>
      </motion.div>
          ...
          {userData ? (
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600">No search results found for the email "{email}".</p>
                <p className="text-gray-600 mt-2">Please check the email address and try again.</p>
              </div>
            </motion.div>
          )}
        </>
